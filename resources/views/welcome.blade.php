...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg transform transition duration-300 hover:scale-105">
                    <img src="{{ asset('img/web-development.png') }}" alt="Web Development" class="w-full h-48 object-cover">
                    <div class="p-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg transform transition duration-300 hover:scale-105">
                    <img src="{{ asset('img/mobile-development.jpeg') }}" alt="Mobile Development" class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            <i class="fas fa-mobile-alt text-2xl text-indigo-600 mr-3"></i>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-lg transform transition duration-300 hover:scale-105">
                    <img src="{{ asset('img/data-science.jpg') }}" alt="Data Science" class="w-full h-48 object-cover">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
    ...
    <footer class="bg-gray-800 text-white py-12">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li><a href="" class="hover:text-white">Mobile Development</a></li>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
